Fork of Adafruit's RTCLib, which is itself a a fork of JeeLab's fantastic real time clock library for Arduino.

Used for my personal projects, which some fixes from the pull-requests of Adafruit's original repository.
